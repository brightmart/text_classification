...
import os
import codecs
from p71_TextRCNN_model import TextRCNN
...
tf.app.flags.DEFINE_string("ckpt_dir","text_rcnn_title_desc_checkpoint/","checkpoint location for the model")
tf.app.flags.DEFINE_integer("sentence_length",100,"max sentence length")
tf.app.flags.DEFINE_integer("embed_size",100,"embedding size")
tf.app.flags.DEFINE_boolean("is_training",False,"is traning.true:tranining,false:testing/inference")
tf.app.flags.DEFINE_string("predict_target_file","text_rcnn_title_desc_checkpoint/zhihu_result_rcnn_multilabel.csv","target file path for final prediction")
