...
Language Understanding Evaluation benchmark for Chinese(<a href='www.CLUEbenchmarks.com'>CLUE benchmark<a/>): run 10 tasks & 9 baselines with one line of code, performance comparision with details.
