...
tf.app.flags.DEFINE_float("decay_rate", 0.87, "Rate of decay for learning rate.") #0.65一次衰减多少
tf.app.flags.DEFINE_string("ckpt_dir","text_hier_atten_title_desc_checkpoint/","checkpoint location for the model")
...
tf.app.flags.DEFINE_string("predict_target_file","text_hier_atten_title_desc_checkpoint/zhihu_result_hier_atten_multilabel.csv","target file path for final prediction")
